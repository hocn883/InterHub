...
function Home() {
  ...
  const loadJobs = async (pageNumber = 0) => {
    try {
      ...
      const openJobs = (pageData?.content || []).filter(
        (job) => job.status === "OPEN"
      );
      setJobs((prev) => {
        const ids = new Set(
    ...
    () => {
      return jobs.filter(
        (job) => {
          ...
          const searchKeyword =
            searchFilters.keyword.toLowerCase();
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Khám phá cơ hội thực tập từ các doanh nghiệp uy tín,
              xây dựng CV chuyên nghiệp và kết nối với giảng viên
              hướng dẫn.
            </p>
        ...
        <div className="section-container">
          <div className="section-heading">
            <div>
              ...
              <p>
                Kết nối với những doanh nghiệp đang có nhu cầu tuyển thực tập sinh.
              </p>
            </div>
          ...
          {employer.length > 0 && (
            <div className="load-more-wrapper">
              {employerHasMore ? (
                ...
                <span className="no-more-jobs">
                  Đã hiển thị tất cả doanh nghiệp
                </span>
              )}
            </div>
          )}
